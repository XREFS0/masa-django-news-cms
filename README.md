# Digital News Portal & Editorial CMS

Modern content management and publishing platform engineered in Django, featuring categorized journalistic articles, editorial workflows, breaking news tickers, and media asset integration.
...
- **Technologies**: Django 4+, SQLite, Pillow, Bootstrap 5, Python 3.11
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-news-cms.git
   cd masa-django-news-cms
   ```
